...
option_types = [
  ...
  {name: 'three_six_days',   presentation:  "3 to 6 days",   attr_type: 'price', travel: true, preciable: true},
  {name: 'seven_thirteen_days',  presentation:  "7 to 13 days",  attr_type: 'price', travel: true, preciable: true },
  {name: 'fourteen_twentynine_days', presentation:  "14 to 29 days", attr_type: 'price', travel: true, preciable: true },
  ...
  {name: "adult", presentation:  "Adult", attr_type: 'pax', short:'Adult', travel: true, preciable: false },
]
